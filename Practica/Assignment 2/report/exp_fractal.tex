...
\begin{figure}
	\centering
	% \includegraphics[width=1\columnwidth]{./img/exp_fractal_cluster}
	\missingfigure{The cluster used as input for the boxcounting algorithm.}
...
\begin{figure}
	\centering
	% \includegraphics[width=1\columnwidth]{./img/exp_fractal_cluster}
	\missingfigure{The number of boxes as function of the box size.}
