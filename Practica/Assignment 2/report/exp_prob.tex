...
\todo[inline]{Code heeft het wel over $p = 0.301, 0.302, \dotsc, 0.7$, maar de plaatjes hebben de range uti de tekst.}
% Ons experiment
...
% \textcite{stauffer1994introduction} has found $p_c$ to be approximately \num{0.59275} for a square lattice.

% \textcite{stauffer1994introduction} has found $p_c$ to be approximately \num{0.59275} for a square lattice.

\todo[inline]{Bepsreek resultaten experiment, kijk het klopt met de theorie. Afwijkingen: N = 41, stopconditie} 
% Discussie
