...
\citeauthor{greene1979method} observed that for small values of $K$ there are many KAM surfaces that encircle the islands horizontally, see \cref{fig:experiment:fancy_k:0}, \ref{fig:experiment:fancy_k:2} and \ref{fig:experiment:fancy_k:4}. These KAM orbits divide the space into several compartments which may contain chaotic orbits. For larger values of $K$ there are fewer KAM orbits and individual chaotic orbits occur a greater are of the phase space. Finally at some critical value of $K$, the last horizontally encircling KAM orbit disappears, this effect can be observed in \cref{fig:experiment:fancy_k:1}. 