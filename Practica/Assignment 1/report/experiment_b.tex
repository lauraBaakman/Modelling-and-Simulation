...
In \Cref{fig:experiment:fancy_k:8}, where $K = 0.8$, we can see that chaos increases, as some regions are already starting to be filled in by two-dimensional orbits, they are especially noticeable in the corners of the plot.
