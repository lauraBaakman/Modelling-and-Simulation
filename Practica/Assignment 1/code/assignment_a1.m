...
number_of_t_plot_iterations = 30;
...
for idx = 1 : length(x_0)
    ...
    high_quality_plot('Save', sprintf('../report/img/assignment_a_%d_dim_n100.pdf', idx - 1), 'FontSize', 22, 'PaperWidth', 8, 'PaperHeight', 8, 'Margin', 0, 'Box', 'on');
...
%     ylabel('{x_{n+1}}');
%     
%     high_quality_plot('Save', sprintf('../report/img/assignment_a_%d_dim_progression_x.pdf', idx - 1), 'FontSize', 22, 'PaperWidth', 8, 'PaperHeight', 8, 'Margin', 0, 'Box', 'on');
...
%     ylabel('{p_{n+1}}');
%     
%     high_quality_plot('Save', sprintf('../report/img/assignment_a_%d_dim_progression_p.pdf', idx - 1), 'FontSize', 22, 'PaperWidth', 8, 'PaperHeight', 8, 'Margin', 0, 'Box', 'on');
...
%     ylim([-0.1, 1.1]);
%     
%     high_quality_plot('Save', sprintf('../report/img/assignment_a_%d_dim_px_of_n.pdf', idx - 1), 'FontSize', 22, 'PaperWidth', 8, 'PaperHeight', 8, 'Margin', 0, 'Box', 'on');
