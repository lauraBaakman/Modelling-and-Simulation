...
%         title(sprintf('x_0 = %2.3f, p_0 = %2.3f', x_0, p_0));
        high_quality_plot('Save', sprintf('../report/img/assignment_b_dim_%d_b_x.pdf', init_idx -1), 'FontSize', 22, 'PaperWidth', 8, 'PaperHeight', 8, 'Margin', 0, 'Box', 'on');
        ...
        ylabel('{p_n}')
%         title(sprintf('x_0 = %2.3f, p_0 = %2.3f', x_0, p_0));        
        high_quality_plot('Save', sprintf('../report/img/assignment_b_dim_%d_b_p.pdf', init_idx -1), 'FontSize', 22, 'PaperWidth', 8, 'PaperHeight', 8, 'Margin', 0, 'Box', 'on');
