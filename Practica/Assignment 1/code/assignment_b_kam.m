...
for k = ks
    ...
    axis([0.35, 0.75, 0, 0.3])
    hold off;
    
    set(gca, 'visible', 'off');
    high_quality_plot('Save', sprintf('../report/img/assignment_b_fancy_k_%d', round(k*10000)), 'FontSize', 22, 'PaperWidth', 4, 'PaperHeight', 4, 'Margin', 0.05);
